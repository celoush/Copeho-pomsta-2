...
list_misto3_patraci joinSilent _group;
...
[_group, 1] setWaypointStatements ["konec_misto3",""]; 
...
} foreach list_misto3_hlidaci;
sleep 1;

{group _x allowFleeing 0;_x setUnitPos "Middle"} foreach list_misto3;
...
list_misto3_hlidaci joinSilent _group;

while {!konec_misto3} do {
  // pri kazdem vystrelu (max. 1x do sekundy) hrace presmeruju WP na hrace
  waitUntil {FIRED or konec_misto3};
